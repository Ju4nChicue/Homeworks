...
import './App.css'
import { FirstApp, Counter, GifExpert, GifGrid, Counter2, Fetch_component, BreakingBad, Memorize, MemoHook, CallbackHook, CallbackHook2, Father, ToDoApp, Parent } from './'

const Home = () =>{

    // const components = [<FirstApp />, <Counter value={0} />, <GifExpert />, <GifGrid category={"algo"} />, <Counter2 value={0}/>, <Fetch_component />, <BreakingBad />]
    // const components = [<Memorize />, <MemoHook />]
